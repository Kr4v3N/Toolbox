...
for value in etsi_data:
    ...
    if "id" in value:
        ...
        if any(value["id"].startswith(f"B.1.1.{i}") for i in range(1, 5)) and value["id"] in output_data:
            print()
        ...
        elif value["id"].startswith("B.1.7.") and value["id"] in output_data:
            print()
        ...
        elif value["id"].startswith("B.1.8.1.1") and value["id"] in output_data:
            print()
